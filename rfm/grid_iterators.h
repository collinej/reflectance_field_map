...
#ifndef RFM_GRID_ITERATORS_H
#define RFM_GRID_ITERATORS_H
...
public:
     ...
     */
    explicit GridIterator(Grid& grid) : GridIterator(0, 0, grid.getWidthInCells(), grid) { }
     ...
     */
    const T& operator*() const { return (*grid_)(x_, y_); }
    T& operator*() { return (*grid_)(x_, y_); }
...
public:
     ...
     * Create an iterator across the entire grid.
     */
    explicit TiledGridIterator(TiledGrid& grid) : TiledGridIterator(0, 0, grid.getWidthInCells(), grid) { }
     ...
     */
    const T& operator*() const { return grid_(x_ * grid_.getTileSize(), y_ * grid_.getTileSize()); }
    T& operator*() { return grid_(x_ * grid_.getTileSize(), y_ * grid_.getTileSize()); }
