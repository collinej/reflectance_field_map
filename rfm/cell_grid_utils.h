 ...
 *   - boundary_update_coords_t : cells within the grid and updateMap region for copying a region into a grid
...
#ifndef RFM_CELL_GRID_UTILS_H
#define RFM_CELL_GRID_UTILS_H
...
/**
 * boundary_update_coords_t considers the boundary of two grids. The updateMap coords are set as the intersection of
...
struct boundary_intersection_t
{
     ...
     *
     * \param    gridBoundary            Boundary of the grid in which the updateMap is being made
     ...
     */
    boundary_intersection_t(const Rectangle<float>& gridBoundary,
                            const Rectangle<float>& updateBoundary,
                            float cellsPerMeter,
