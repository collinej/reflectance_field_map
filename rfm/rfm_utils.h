 ...
 *
 * Declaration of utility functions for interacting with the RFM:
 *
...
#ifndef RFM_RFM_UTILS_H
#define RFM_RFM_UTILS_H
 ...
 *
 * \param    map         RFM in which to get the active region
...
/**
 * angle_bins_to_angle_range converts angle bins in the RFM to an angle range. The requested cell must be in the
